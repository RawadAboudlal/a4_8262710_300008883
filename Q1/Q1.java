...
public class Q1 {
	...
	System.out.print("It took " + (end - start) + " ms with ITI1121StringBuffer (" + (inter - start)
		+ " to append and " + (end - inter) + " to generate).");
	...
	/*
	 * ITIStringBuffer marco = new ITIStringBuffer(); marco.append("Marco");
	 * marco.append(" Polo"); System.out.println(marco);
	 * marco.append(" walks into a bar..."); System.out.println(marco.toString());
	 */
